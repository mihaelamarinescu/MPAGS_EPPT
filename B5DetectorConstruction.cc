...
G4VPhysicalVolume* B5DetectorConstruction::Construct()
{
  ...
  // first lead sheet
  // auto leadSheet  = new G4Box("leadSheet",1.*m,30.*cm,2.5*cm);
  // auto leadLogical = new G4LogicalVolume(leadSheet,lead,"leadLogical");
  // new G4PVPlacement(0,G4ThreeVector(0.,0.,-1.03*m),leadLogical,"leadPhysical",worldLogical,false,0,checkOverlaps);
